...
public static class ActionHelper
{
    ...
    /// set Vibration
    /// </summary>
    public static void SetVibration(long milliseconds, int amplitude)
    {
        if (!IsEditor())
        {
            // call vibration
    ...
    public static int GetScoreSurvivor(int bossKilled, int enemyKilled)
    {
        //return enemyKilled * 100 + timeLife * 10;
        return (enemyKilled + bossKilled * 5) * 100;
    }
    /// <summary>
